...
Statement -> VarDecl | FnDecl | StructDecl | TraitDecl | ImplDecl | TypeAliasDecl | EnumDecl | ControlFlow | Expr SEMICOLON
...
TraitFn -> Attributes FN IDENT Generics? LPAREN Params RPAREN (ARROW TYPE)? (Block | SEMICOLON)
